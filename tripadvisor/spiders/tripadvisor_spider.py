...
class TripadvisorSpider(Spider):
    ...
    def parse_page(self, response):
        ...
        pulled_review = response.xpath('//div[@class="ui_column is-8 main_col allowEllipsis"]')
    ...
    def parse_review(self, response):
        ...
        num_excellent = response.xpath('.//div[@class="ui_column is-5 is-12-mobile"]//span/text()').extract()[0]
        num_good = response.xpath('.//div[@class="ui_column is-5 is-12-mobile"]//span/text()').extract()[1]
        num_avg = response.xpath('.//div[@class="ui_column is-5 is-12-mobile"]//span/text()').extract()[2]
        num_poor = response.xpath('.//div[@class="ui_column is-5 is-12-mobile"]//span/text()').extract()[3]
        num_bad = response.xpath('.//div[@class="ui_column is-5 is-12-mobile"]//span/text()').extract()[4]
        ...
        item['num_excellent'] = num_excellent
        item['num_good'] = num_good
        item['num_avg'] = num_avg
        item['num_poor'] = num_poor
        item['num_bad'] = num_bad
        yield item